...
import {
  ...
  Bot,
  Sparkles,
  GraduationCap, // Added icon for Education
} from "lucide-react";
...
const personalInfo = {
  ...
  bio: "Currently pursuing Computer Science at Duke University. Passionate about building intelligent systems that solve real-world problems. Experienced in scaling AI agents, redesigning user experiences, and architecting robust full-stack solutions.",
  bioHighlight: { text: "Duke University", start: 39, end: 54 },
  socials: {
...
// UPDATED: Added paths to images. 
// NOTE: Ensure you have these PNGs in your src/assets folder or update these paths.
const experience = [
  {
    company: "Crewscale",
    logo: "/src/assets/crewscale.png", // Update this path
  ...
  },
  {
    ...
    logo: "/src/assets/intelliflow.png", // Update this path
  ...
  {
    company: "KredX",
    logo: "/src/assets/kredx.png", // Update this path
  ...
  {
    company: "Capgemini",
    logo: "/src/assets/capgemini.png", // Update this path
...
const projects = [
  {
    ...
    desc: "Seamless ride scheduling & navigation system.",
    year: "2024",
  },
  {
    title: "Forest Vision",
    tech: "CNN / TensorFlow",
    desc: "Satellite imagery analysis for forest cover prediction.",
    year: "2023",
  },
];
...
Name: Harsh Gupta
Title: AI + Full-Stack Developer | Duke MEM (Incoming) | Aspiring Product Ops Manager
...
const AskMeAnythingModal = ({ isOpen, onClose, isDark }) => {
  ...
  const handleSearch = async (e) => {
    ...
    const apiKey = "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";
  ...
  >
    ...
    >
      {isDark ? (
        ...
        <Moon size={13} className="text-neutral-900" />
      )}
    </motion.div>
  </motion.button>
);
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-700 ease-in-out ${
        isDark ? "bg-neutral-950 text-neutral-300" : "bg-white text-neutral-800"
      }`}
    >
      <style>{`
        @keyframes marquee {
      ...
      <nav className="fixed top-0 w-full px-4 py-4 md:px-8 md:py-6 flex justify-between items-center z-40 backdrop-blur-md bg-white/90 dark:bg-neutral-950/90 border-b border-transparent hover:border-neutral-100 dark:hover:border-neutral-900 transition-all">
        <motion.span
          className="font-medium text-sm tracking-tight text-neutral-900 dark:text-neutral-100"
        ...
        <div className="flex items-center gap-4 md:gap-8">
          ...
          >
            {[
              ...
              { name: "Education", id: "education", short: "Edu" }, // Added to Nav
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-8 lg:gap-12 items-center">
          ...
          <Reveal delay={0.35}>
            <div className="relative order-first lg:order-last mt-8 lg:mt-0 group">
              ...
              >
                <div className="aspect-[3/4] bg-gradient-to-br from-neutral-100 to-neutral-200 dark:from-neutral-900 dark:to-neutral-800 relative overflow-hidden group">
                  <img
      ...
      {/* Experience - UPDATED TO SUPPORT LOGOS */}
      <section
        id="experience"
        ...
        <div className="space-y-8 md:space-y-10">
          {experience.map((job, i) => (
            <Reveal key={i} delay={i * 0.1}>
              ...
              >
                {/* Card Container */}
                <div className="relative bg-white dark:bg-neutral-900/50 border border-neutral-100 dark:border-neutral-800 hover:border-orange-500/30 dark:hover:border-orange-500/30 transition-all duration-300 p-5 md:p-6">
                  {/* Header: Logo, Company, Role, Dates */}
                  <div className="flex items-start gap-4 mb-5">
                    {/* Company Logo - Updated Render Logic */}
                    <motion.div
                      className="w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br from-neutral-100 to-neutral-200 dark:from-neutral-800 dark:to-neutral-800 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300 overflow-hidden"
                      whileHover={{ rotate: 5 }}
                    >
                      ...
                      <span className={`text-base md:text-lg font-bold text-orange-500 ${job.logo.includes("/") ? 'hidden' : 'block'}`}>
                        {job.logo.includes("/") ? job.company.charAt(0) : job.logo}
                      </span>
                    </motion.div>
          ...
          {projects.map((project, i) => (
            <Reveal key={i} delay={i * 0.1}>
              <div className="group cursor-pointer">
                {/* Image Container */}
                <motion.div
                  className="aspect-[16/10] bg-neutral-100 dark:bg-neutral-900 relative overflow-hidden mb-6 border border-transparent group-hover:border-orange-500/20 transition-all duration-500"
                  whileHover={{ scale: 1.02 }}
                  transition={{ duration: 0.4 }}
                >
                  <div className="w-full h-full flex items-center justify-center text-neutral-300 dark:text-neutral-800 bg-neutral-50 dark:bg-neutral-900/50">
                    <motion.div className="text-2xl md:text-3xl font-serif italic opacity-30 group-hover:text-orange-500 group-hover:opacity-40 transition-colors duration-500">
                      {project.title}
                    </motion.div>
                  </div>
                ...
                {/* Content - Visible below image */}
                <div className="space-y-3">
                  <div className="flex justify-between items-start">
                    <h3 className="text-xl font-medium text-neutral-900 dark:text-neutral-100 group-hover:text-orange-500 transition-colors">
                      {project.title}
                    </h3>
                    <span className="text-[10px] font-mono py-1 px-2 border border-neutral-200 dark:border-neutral-800 rounded-full text-neutral-500">
                      {project.tech}
                    </span>
                  </div>
